...
export const opacityToHighHover = configurations =>  
  createAnimationConfig(Animations.opacityToHighAnimation,configurations || {}, true)
...
export const lowPulseOnHover = configurations =>
  createAnimationConfig(Animations.lowPulseAnimation,configurations || {}, true)
...
export const fastPulsateXOnHover = configurations =>
  createAnimationConfig(Animations.pulsateXAnimation,configurations || {}, true)
export const slowPulsateXOnHover = configurations =>
  createAnimationConfig(Animations.pulsateXAnimation,configurations || {}, true)
export const fastPulsateYOnHover = configurations =>
  createAnimationConfig(Animations.pulsateYAnimation,configurations || {}, true)
export const slowPulsateYOnHover = configurations =>
  createAnimationConfig(Animations.pulsateYAnimation,configurations || {}, true)
export const pulsateWithSpinOnHover = configurations =>
  createAnimationConfig(Animations.pulsateWithSpinAnimation,configurations || {}, true)
export const opacityPulseOnHover = configurations =>
  createAnimationConfig(Animations.opacityPulseAnimation,configurations || {}, true)
...
export const shakeBellOnHover = configurations =>
  createAnimationConfig(Animations.shakeBellAnimation,configurations || {}, true)
...
export const shiftRightOnHover = configurations => 
  createAnimationConfig(Animations.shiftRightAnimation,configurations || {}, true)
export const shiftLeftOnHover = configurations => 
  createAnimationConfig(Animations.shiftLeftAnimation,configurations || {}, true)
...
export const shiftDownOnHover = configurations => 
  createAnimationConfig(Animations.shiftDownAnimation,configurations || {}, true)
export const blinkingOnHover = configurations =>
  createAnimationConfig(Animations.blinkingAnimation,configurations || {}, true)
