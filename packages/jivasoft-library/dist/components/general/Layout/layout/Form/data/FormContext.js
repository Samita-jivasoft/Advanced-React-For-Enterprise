...
exports.useForm = exports.FormContextProvider = void 0;
...
const FormContextProvider = _ref => {
  let {
    children,
    initialState,
    reducer
  } = _ref;
  const [formState, formDispatch] = (0, _react.useReducer)(reducer, initialState);
  return /*#__PURE__*/_react.default.createElement(FormContext.Provider, {
    value: [formState, formDispatch]
  }, children);
};
