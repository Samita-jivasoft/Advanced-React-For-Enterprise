...
const BannerPosition = props => {
  ...
  // console.log("The banner title-size is ", props?.titleSize)
  const bannerOrder = [/*#__PURE__*/_react.default.createElement(_style.StyledTitleBox, {
    ...
    titleSize: props === null || props === void 0 ? void 0 : props.titleSize //Added
    ...
    style: {
      fontSize: props === null || props === void 0 ? void 0 : props.titleSize,
      fontWeight: 800
    }
