...
const WeekHeader = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement(_.StyledTh, null, /*#__PURE__*/_react.default.createElement(_.DayLabel, null, dateRows.length > 2 && /*#__PURE__*/_react.default.createElement(_.StyledInput, {
    type: "checkbox",
    id: dayName,
    checked: checkState,
...
const DateRange = _ref2 => {
  ...
  return /*#__PURE__*/_react.default.createElement(_general.AnimatedDynamicModal, {
    ...
    headerItems: masktype === 'date' ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_general.DynamicButtonV2, {
      onClick: () => setDateChange(true),
      color: themeState.currentTheme.text,
      text: 'Adjust Dates',
      backgroundColor: themeState.currentTheme.overlayDimmest
    })) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_general.DynamicButtonV2, {
      onClick: () => setDateChange(true),
      color: themeState.currentTheme.text,
      text: 'Adjust Dates',
      backgroundColor: themeState.currentTheme.overlayDimmest
    ...
    headerText: tempArr.length > 0 && /*#__PURE__*/_react.default.createElement("div", {
      style: {
        marginLeft: 'calc(10px + 5vmin)'
      }
    }, (0, _helpers.returnDate)(tempArr[0].date.slice(0, 10)), " - ", (0, _helpers.returnDate)(tempArr[tempArr.length - 1].date.slice(0, 10))),
    dismissable: true
  }, /*#__PURE__*/_react.default.createElement(_.OverflowContainer, null, /*#__PURE__*/_react.default.createElement(_.StyledTable, null, /*#__PURE__*/_react.default.createElement(_.StyledThead, null, /*#__PURE__*/_react.default.createElement(_.HeaderTr, null, dayHeader.map((day, idx) => /*#__PURE__*/_react.default.createElement(WeekHeader, {
    dayName: day,
    dayNum: idx,
    dateRows: dateRows,
    handleWeekSelection: handleWeekSelection
  })))), /*#__PURE__*/_react.default.createElement(_.StyledBody, null, dateRows.map(rowObj => {
    return /*#__PURE__*/_react.default.createElement(_.RowTr, null, rowObj.map(item => /*#__PURE__*/_react.default.createElement(_.RowTd
    // dimRem={4}
    // hSize={12}
    // wSize={8}
    , null, item && /*#__PURE__*/_react.default.createElement(_.ItemDate, {
      item: item,
      tempArr: tempArr,
      dateRows: dateRows,
      masktype: masktype,
  ...
  })))), dateChange && /*#__PURE__*/_react.default.createElement(_general.AnimatedDynamicModal, {
    type: 'bottom sheet',
    ...
    backgroundColor: themeState.currentTheme.bg0,
    dismissable: true
  }, /*#__PURE__*/_react.default.createElement(_.LabelDiv, {
    height: '30vh',
    width: 100
  }, /*#__PURE__*/_react.default.createElement(_.InputDiv, {
    height: 90,
    width: 45
  }, /*#__PURE__*/_react.default.createElement(_.NameDiv, null, "Start Date", dateWarning.startWarning ? /*#__PURE__*/_react.default.createElement(_.XIcon, null) : /*#__PURE__*/_react.default.createElement(_.CheckIcon, null)), /*#__PURE__*/_react.default.createElement(_.DateInput, {
    type: "date",
    id: "startingdate",
  ...
  }), /*#__PURE__*/_react.default.createElement(_.NameDiv, null, dateWarning.startWarning ? 'Error: Invalid Date range' : null)), /*#__PURE__*/_react.default.createElement("div", null, "to"), /*#__PURE__*/_react.default.createElement(_.InputDiv, {
    height: 90,
    width: 45
  }, /*#__PURE__*/_react.default.createElement(_.NameDiv, null, "End Date", dateWarning.endWarning ? /*#__PURE__*/_react.default.createElement(_.XIcon, null) : /*#__PURE__*/_react.default.createElement(_.CheckIcon, null)), /*#__PURE__*/_react.default.createElement(_.DateInput, {
  ...
  }), /*#__PURE__*/_react.default.createElement(_.NameDiv, null, dateWarning.endWarning ? 'Error: Invalid Date range' : null)))), timeChange && /*#__PURE__*/_react.default.createElement(_general.AnimatedDynamicModal, {
    type: 'bottom sheet',
    ...
    height: 90,
    width: 45
  }, /*#__PURE__*/_react.default.createElement(_.NameDiv, null, "Start Time \xA0", timeWarning ? /*#__PURE__*/_react.default.createElement(_.XIcon, null) : null), /*#__PURE__*/_react.default.createElement(_.StyledTimePicker, {
    ...
    disableClock: true,
    selected: true
  }), /*#__PURE__*/_react.default.createElement(_.NameDiv, null, timeWarning ? 'Error: Invalid Time Range' : null)), /*#__PURE__*/_react.default.createElement("div", {
    style: {
      padding: '0 4px 0 4px'
    }
    ...
    height: 90,
    width: 45
  }, /*#__PURE__*/_react.default.createElement(_.NameDiv, null, "End Time \xA0", timeWarning ? /*#__PURE__*/_react.default.createElement(_.XIcon, null) : null), /*#__PURE__*/_react.default.createElement(_.StyledTimePicker, {
    ...
    disableClock: true,
    selected: true
  }), /*#__PURE__*/_react.default.createElement(_.NameDiv, null, timeWarning ? 'Error: Invalid Time Range' : null)))));
};
