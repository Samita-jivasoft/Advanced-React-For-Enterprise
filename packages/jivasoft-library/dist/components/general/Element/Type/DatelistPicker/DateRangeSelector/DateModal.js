...
const DateRange = _ref2 => {
  ...
  (0, _react.useEffect)(() => {
    dateArr.length > 0 && setDtArray([...dateArr]);
  }, [dateArr]);
  ...
  //Previously: The returnDate was explicitly defined in the file,
  ...
  const [showDate, setShowDate] = (0, _react.useState)(false);
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, dateChange && /*#__PURE__*/_react.default.createElement(_general.AnimatedDynamicModal, {
    type: 'bottom sheet',
    onClose: () => setDateChange(false),
    headerText: 'Adjust Date Range',
    themeColor: themeState.currentTheme.bg0,
    fontColor: themeState.currentTheme.text,
    backgroundColor: themeState.currentTheme.bg,
    dismissable: true
  ...
  }, "START DATE", dateWarning.startWarning ? /*#__PURE__*/_react.default.createElement(_.XIcon, null) : /*#__PURE__*/_react.default.createElement(_.CheckIcon, null)), /*#__PURE__*/_react.default.createElement(_.DateInput, {
    type: "date",
    id: "startingdate",
  ...
  }), /*#__PURE__*/_react.default.createElement(_.NameDiv, null, dateWarning.startWarning ? 'Error: Invalid Date range' : null)), /*#__PURE__*/_react.default.createElement("div", {
    style: {
      margin: 10
    }
  }), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, "END DATE", dateWarning.endWarning ? /*#__PURE__*/_react.default.createElement(_.XIcon, null) : /*#__PURE__*/_react.default.createElement(_.CheckIcon, null)), /*#__PURE__*/_react.default.createElement(_.DateInput, {
    type: "date",
    id: "startingdate",
    value: dateVal.enddate || tempArr[0].date.slice(0, 10) || '',
    onChange: e => setDateVal(_objectSpread(_objectSpread({}, dateVal), {}, {
    ...
    handleParent: value => {
      if (value) {
        ...
        setTimeVal(_objectSpread(_objectSpread({}, timeVal), {}, {
          starttime: time[0]
        }));
      }
    },
    canedit: 1
  })), /*#__PURE__*/_react.default.createElement(_.NameDiv, null, timeWarning ? 'Error: Invalid Time Range' : null)), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", {
    style: {
      opacity: 0.7,
      fontWeight: 550,
      fontSize: '.66rem'
    ...
    canedit: 1
  })), /*#__PURE__*/_react.default.createElement(_.NameDiv, null, timeWarning ? 'Error: Invalid Time Range' : null)))), /*#__PURE__*/_react.default.createElement(_general.AnimatedDynamicModal, {
    type: viewWidth > 800 ? 'modal' : 'fullscreen',
    onClose: () => setOpen(false),
    fontColor: themeState.currentTheme.text,
    themeColor: themeState.currentTheme.bga3,
    backgroundColor: themeState.currentTheme.bga2,
    footer: 1,
    footerText: 'Tap or click a date to select/deselect it.',
    headerItems: masktype === 'date' ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
      style: {
        margin: 5
      }
    }, ' ', /*#__PURE__*/_react.default.createElement(_general.DynamicButtonV2, {
      text: 'Ok',
      backgroundColor: themeState.currentTheme.primaryColorBase,
      color: 'white',
