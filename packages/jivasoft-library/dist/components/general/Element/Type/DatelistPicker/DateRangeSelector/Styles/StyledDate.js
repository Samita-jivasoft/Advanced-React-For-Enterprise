...
}, props => props.fontRem + 'rem', props => props.fontVMin + 'vmin', _ref23 => {
  let {
    selected
  } = _ref23;
  return selected ? _ref24 => {
    let {
      theme
    } = _ref24;
    return theme.primaryTintBase;
...
const DisplayTime = exports.DisplayTime = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex; \n  position:relative;\n  border-top:1px solid ", ";\n  flex-direction: column;\n  align-items: center;\n  justify-Content: center;\n  //background: purple;\n  font-size: calc(.25rem + 1vmin);\n  padding: ", "; \n  margin: ", ";\n  //padding-top: 10px;\n  //height: 50%;\n  width: 100%;   \n "])), _ref30 => {
  ...
  return theme.text;
}, props => props.viewWidth > 600 ? 5 : 0, props => props.viewWidth > 600 ? 5 : 0);
