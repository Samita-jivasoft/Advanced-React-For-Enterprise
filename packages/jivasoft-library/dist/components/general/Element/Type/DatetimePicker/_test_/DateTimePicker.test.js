...
var _Datepicker = require("../../DatelistPicker/DateRangeSelector/Datepicker");
...
describe('DatetimePicker Integration Test', () => {
  ...
  test('should render with the default props ', () => {
    (0, _react2.render)(/*#__PURE__*/_react.default.createElement(_Datepicker.DatetimePicker, null));
  });
