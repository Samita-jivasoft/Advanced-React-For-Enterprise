...
const BannerPositionCenter = props => {
  ...
  //animate={{y: isVisible ? null : -200}}
  , null, !isMobile && firstHalf.length > 0 && /*#__PURE__*/_react.default.createElement(_style.ItemsContainer, {
    id: "leftitems",
    condensed: condensed,
    direction: position,
    style: {
      justifyContent: leftItemsOverflow && condensed ? 'flex-start' : 'space-evenly'
    }
  ...
  }, i))), /*#__PURE__*/_react.default.createElement(_style.StyledCenterTitleBox, null, /*#__PURE__*/_react.default.createElement(_style.CenterTitleBox, null, (leftIcons || rightIcons) && /*#__PURE__*/_react.default.createElement(_style.TitleBoxItem, {
    style: {
      justifyContent: 'center'
    }
  }, leftIcons && leftIcons.length > 0 && leftIcons.map((i, index) => /*#__PURE__*/_react.default.createElement("div", {
    style: {
  ...
  }, subText), condensed && (preText || subText) && /*#__PURE__*/_react.default.createElement(_Tooltip.Tooltip, {
    ...
    size: 15
  })))), (rightIcons || leftIcons) && /*#__PURE__*/_react.default.createElement(_style.TitleBoxItem, {
    style: {
      justifyContent: 'center'
    }
  ...
  }, i)))), !isMobile && secondHalf.length > 0 && /*#__PURE__*/_react.default.createElement(_style.ItemsContainer, {
    id: "rightitems",
    condensed: condensed,
    direction: 'flex-start',
    style: {
      justifyContent: rightItemsOverflow && condensed ? null : 'space-evenly'
      // marginLeft: '5px'
    }
