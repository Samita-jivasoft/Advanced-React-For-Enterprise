...
const BannerPosition = props => {
  ...
  const HeaderTitle = () => {
    ...
    }, condensed && (preText || subText) && position === 'flex-end' && /*#__PURE__*/_react.default.createElement(_Tooltip.Tooltip, {
    ...
    }, subText), condensed && (preText || subText) && (position === 'flex-start' || position === 'center') && /*#__PURE__*/_react.default.createElement(_Tooltip.Tooltip, {
      headerColor: headerColor,
      themeColor: themeColor,
      color: color,
      direction: position === 'flex-end' ? 'bottom' : 'right',
