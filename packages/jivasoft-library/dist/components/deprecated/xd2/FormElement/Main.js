...
var _DateRangeSelector = require("components/DateRangeSelector");
...
const FormElement = props => {
  ...
  }, /*#__PURE__*/_react.default.createElement(_DateRangeSelector.DateSelector, {
  ...
  })) : masktype === 'textarea' ? /*#__PURE__*/_react.default.createElement(_Main.TextAreaStyled, {
    isValid: formElementValue.isValid,
    value: formElementValue.value,
    onChange: e => {
      var _formElementValue$ele;
      setFormElementValue(_objectSpread(_objectSpread({}, formElementValue), {}, {
        value: e.target.value,
        isValid: (formElementValue === null || formElementValue === void 0 || (_formElementValue$ele = formElementValue.element) === null || _formElementValue$ele === void 0 ? void 0 : _formElementValue$ele.required) === 1 ? e.target.value.length > 0 ? true : false : true
      }));
    }
