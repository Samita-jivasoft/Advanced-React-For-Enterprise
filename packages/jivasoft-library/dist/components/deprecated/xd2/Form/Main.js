...
const Form = exports.Form = /*#__PURE__*/_react.default.memo(props => {
  const {
    formElements,
    formLabel,
    parentState,
  ...
  function generateGroupArray() {
    ...
    const groups = Array.from(groupsMap.values()).sort((a, b) => {
      var _ref, _a$sequence;
      return (_ref = (_a$sequence = a === null || a === void 0 ? void 0 : a.sequence) !== null && _a$sequence !== void 0 ? _a$sequence : 0 - (b === null || b === void 0 ? void 0 : b.sequence)) !== null && _ref !== void 0 ? _ref : 0;
    });
    return groups;
  }
  function getTabs() {
  ...
  }, /*#__PURE__*/_react.default.createElement(_Form.FormStyledHeader, null, tabState && !isReview && /*#__PURE__*/_react.default.createElement(_components.Tabs, {
    selected: selected,
  ...
  }, formLabel ? formLabel : 'Form')), formElements && !isReview && formElements.sort((a, b) => a.sequence > b.sequence ? 1 : -1).map(element => {
  ...
  }), isReview && reviewForm.sort((a, b) => a.element.sequence > b.element.sequence ? 1 : -1).map(element => {
    return /*#__PURE__*/_react.default.createElement(_ReviewElement.FormReviewElement, {
      key: element.formelementid,
      element: element,
