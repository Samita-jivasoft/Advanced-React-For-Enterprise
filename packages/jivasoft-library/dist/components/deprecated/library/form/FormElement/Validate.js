...
const setZeros = (e, required, datatype, percision, validminimum, formElementValue, setFormElementValue, setCompletedRequirements, setRemainingRequirements) => {
  ...
  if (parseInt(e.target.value) >= parseInt(e.target.min) && parseInt(e.target.value) <= parseInt(e.target.max) || !required && !e.target.value) {
    ...
    completedRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.CompletedRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaCheck, null), ' ', /*#__PURE__*/_react.default.createElement("b", null, 'Valid range is ' + e.target.min + ' to ' + e.target.max), ' '));
  } else {
    setFormElementValue(_objectSpread(_objectSpread({}, formElementValue), {}, {
      value: e.target.value,
      isValid: false
    }));
    remainingRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.RemainingRecsStyled, null, /*#__PURE__*/_react.default.createElement(_fa.FaTimes, null), ' ', /*#__PURE__*/_react.default.createElement("b", null, 'Valid range is ' + e.target.min + ' to ' + e.target.max), ' '));
  }
  setCompletedRequirements(completedRequirements);
  setRemainingRequirements(remainingRequirements);
};
...
const validateEmail = (value, element, remainingRequirements, completedRequirements) => {
  validEmail.test(value) ? completedRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.CompletedRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaCheck, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Valid'), ' ')) : remainingRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.RemainingRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaTimes, null), ' ', /*#__PURE__*/_react.default.createElement("b", null, 'Enter a valid email in the example@email.com format'), ' '));
  var min = element.validminimum || 0;
  var max = element.validmaximum || 200;
  if (value.length <= max && value.length >= min) {
    completedRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.CompletedRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaCheck, null), " ", /*#__PURE__*/_react.default.createElement("b", null, min + ' to ' + max + ' characters'), ' '));
  } else remainingRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.RemainingRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaTimes, null), " ", /*#__PURE__*/_react.default.createElement("b", null, min + ' to ' + max + ' characters'), ' '));
};
...
const validatePhoneNumber = (value, remainingRequirements, completedRequirements) => {
  validPhoneNumber.test(value.substring(0, 16)) ? completedRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.CompletedRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaCheck, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Valid Phone Number'), ' ')) : remainingRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.RemainingRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaTimes, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Invalid Phone Number'), ' '));
};
/* Format Phone Number */
...
const validateDate = (value, format, element, remainingRequirements, completedRequirements) => {
  if (value) {
    completedRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.CompletedRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaCheck, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Valid Date')));
  } else {
    remainingRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.RemainingRecsStyled, null, /*#__PURE__*/_react.default.createElement(_fa.FaTimes, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Invalid Date')));
  }
};
...
const validateString = (value, element, remainingRequirements, completedRequirements) => {
  ...
  if (typeof value === 'string' && value) completedRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.CompletedRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaCheck, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Valid'), ' '));else remainingRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.RemainingRecsStyled, null, /*#__PURE__*/_react.default.createElement(_fa.FaTimes, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Field Empty'), ' '));
};
...
const validateInt = (value, element, remainingRequirements, completedRequirements) => {
  ...
  if (value <= max && value >= min || !element.required && !value) {
    completedRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.CompletedRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaCheck, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Valid range is ' + min + ' to ' + max), ' '));
  } else {
    remainingRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.RemainingRecsStyled, null, /*#__PURE__*/_react.default.createElement(_fa.FaTimes, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Valid range is ' + min + ' to ' + max), ' '));
  }
};
...
const validateBoolean = (value, element, remainingRequirements, completedRequirements) => {
  if (value === '1' || value === '0') {
    completedRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.CompletedRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaCheck, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Valid Boolean'), ' '));
  } else {
    remainingRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.RemainingRecsStyled, null, /*#__PURE__*/_react.default.createElement(_fa.FaTimes, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Valid Boolean'), ' '));
  }
};
...
const validateCode = (otp, codeLength, setCompletedRequirements, setRemainingRequirements) => {
  ...
  if (x.length === codeLength) {
    completedRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.CompletedRecsStyled, null, ' ', /*#__PURE__*/_react.default.createElement(_fa.FaCheck, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Valid code'), ' '));
  } else {
    remainingRequirements.push(/*#__PURE__*/_react.default.createElement(_Main.RemainingRecsStyled, null, /*#__PURE__*/_react.default.createElement(_fa.FaTimes, null), " ", /*#__PURE__*/_react.default.createElement("b", null, 'Fields should not be empty '), ' '));
  }
  setCompletedRequirements(completedRequirements);
  setRemainingRequirements(remainingRequirements);
};
