...
exports.searchSort = exports.handleSorting = void 0;
require("core-js/modules/es.array.includes.js");
require("core-js/modules/es.array.sort.js");
require("core-js/modules/es.regexp.to-string.js");
require("core-js/modules/es.string.includes.js");
// returns sorted array in accending or decending order
const handleSorting = (array, sortField, sortOrder) => {
...
const searchSort = (array, searchColumn, value, sortField, sortOrder) => {
  // console.log("searching!")
  function results(res) {
    // console.log(
    //   array.some(row => searchColumn.filter(col => row[col].toString().includes(value)))
    // )
    return array.map(x => searchColumn.map(i => x[i].toString().includes(value)).some(element => element === true) ? res ? x : null : res ? null : x).filter(n => n);
  }
  // console.log(results)
