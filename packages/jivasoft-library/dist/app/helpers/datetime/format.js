...
exports.boundDates = boundDates;
exports.formatDate = formatDate;
exports.formatDatePart = formatDatePart;
exports.formatIsoStringToMMDDYY = formatIsoStringToMMDDYY;
exports.formatIsoStringToMMDDYYYY = formatIsoStringToMMDDYYYY;
exports.getUTCTime = getUTCTime;
exports.isValidISODate = isValidISODate;
exports.leadingZeros = void 0;
exports.makeIsoString = makeIsoString;
...
function formatDate(date, format) {
  ...
  switch (format) {
    case 'year':
      return datetime === null || datetime === void 0 ? void 0 : datetime.getUTCFullYear();
    case 'month':
      return months === null || months === void 0 ? void 0 : months[datetime.getUTCMonth()];
    case 'daysOfWeekCondensed':
      return daysOfWeekCondensed === null || daysOfWeekCondensed === void 0 ? void 0 : daysOfWeekCondensed[datetime.getUTCDay()];
    case 'dayOfWeek':
      return daysOfWeek === null || daysOfWeek === void 0 ? void 0 : daysOfWeek[datetime.getUTCDay()];
    case 'date':
...
function formatIsoStringToMMDDYY(isoString) {
...
function getUTCTime(isoString) {
  let is12HourFormat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
function boundDates(dateValue, validMinimum, validMaximum) {
...
function formatDatePart(dateVar, timeVar) {
...
function makeIsoString(hours, minutes, AMorPM, twelvehr) {
  let hour = '';
  if (hours !== undefined && minutes !== undefined && hours.length !== 0 && minutes.length !== 0) {
    if (twelvehr) {
      if (hours === '12' && AMorPM === 'AM') hour = '00';else hour = hours;
      if (AMorPM === 'PM' && hours !== '12') hour = parseInt(hours, 10) + 12;
      return new Date(Date.UTC(2022, 1, 1, hour, minutes, 0)).toISOString();
    } else return new Date(Date.UTC(2022, 1, 1, hours, minutes, 0)).toISOString();
  } else return null;
}
...
const leadingZeros = (e, setHours, setMinutes) => {
  if (e.target.value < 10 && e.target.value.length === 1) e.target.value = '0' + e.target.value;else e.target.value = e.target.value;
