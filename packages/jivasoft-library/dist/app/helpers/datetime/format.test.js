...
describe("formatDate function", () => {
  ...
  describe("Valid Input", () => {
    test("for Format 'date'", () => {
      ...
      expect((0, _helpers.formatDate)(date, format)).toEqual(expectedOutput);
    });
  ...
  describe("Invalid Input", () => {
    ...
    test("for Invalid Date Input", () => {
      ...
      expect((0, _helpers.formatDate)(badDate, format)).toEqual(expectedOutput);
    });
  });
});
...
describe("formatIsoStringToMMDDYY function", () => {
  test("for valid date input", () => {
    ...
    expect((0, _helpers.formatIsoStringToMMDDYY)(isoString)).toEqual(expectedOutput);
  });
  test("for invalid date input", () => {
...
describe("getUTCTime function", () => {
  test("for 24-Hour Format", () => {
    ...
    expect((0, _helpers.getUTCTime)(isoString)).toEqual(expectedOutput);
  });
  test("for 12-Hour Format [AM]", () => {
    const isoString = "2024-05-30T08:30:45Z";
    const expectedOutput = "08:30 AM";
    expect((0, _helpers.getUTCTime)(isoString, true)).toEqual(expectedOutput);
  });
...
describe("isValidISO", () => {
  describe("for valid input", () => {
    test("for valid ISO 8601 date string", () => {
      ...
      expect((0, _helpers.isValidISODate)(dateString)).toEqual(expectedOutput);
    });
...
describe("boundDates function", () => {
  test("when within range", () => {
    ...
    expect((0, _helpers.boundDates)(dateValue, validMinimum, validMaximum)).toEqual(expectedOutput);
  });
});
...
describe("returnDate function", () => {
  test("for YYYY-MM-DD", () => {
    ...
    expect((0, _helpers.returnDate)(date)).toEqual(expectedOutout);
  });
  test("for YYYY/MM/DD", () => {
    const date = "2025/09/01";
    const expectedOutput = "09/01/2025";
    expect((0, _helpers.returnDate)(date)).toEqual(expectedOutput);
  });
  test.skip("for null Input", () => {
    const date = null; //or undefined
    expect((0, _helpers.returnDate)(date)).toBeNull();
  }); //Not handled
...
describe("formatDatePart function", () => {
  test("for input as Date Only", () => {
    ...
    expect((0, _helpers.formatDatePart)(date)).toEqual(expectedOutput);
  });
  test("for Date and Time", () => {
    ...
    expect((0, _helpers.formatDatePart)(date, time)).toEqual(expectedOutput);
  }); //Needs Review
  ...
  test.skip("for null ", () => {
    const date = null;
    const time = null;
    expect((0, _helpers.formatDatePart)(date, time)).toBeNull();
  }); //Needs Review
});
...
describe("makeIsoString function", () => {
  describe("Valid Input", () => {
    test("for 24-hour format", () => {
      ...
      expect((0, _helpers.makeIsoString)(hours, minutes, AMorPM, twelvehr)).toEqual(expectedOutput);
    });
    test("for 12-hour format [AM]", () => {
      const hours = "10";
      const minutes = "15";
  ...
  describe("Invalid Input", () => {
    test("for Invalid input", () => {
      ...
      const AMorPM = "";
      const twelvehr = false;
      expect((0, _helpers.makeIsoString)(hours, minutes, AMorPM, twelvehr)).toBeNull();
    });
  });
});
...
describe("leadingZeros", () => {
  describe("Single Digit Input", () => {
    test("for the single-digit hours", () => {
      ...
      (0, _helpers.leadingZeros)(event, setHours, setMinutes);
