...
exports.useMenu = exports.MenuContextProvider = exports.MenuContext = void 0;
...
const MenuContextProvider = _ref => {
  let {
    children,
    initialState,
    reducer
  } = _ref;
  const [menuState, menuDispatch] = (0, _react.useReducer)(reducer, initialState);
  return /*#__PURE__*/_react.default.createElement(MenuContext.Provider, {
    value: [menuState, menuDispatch]
  }, children);
};
