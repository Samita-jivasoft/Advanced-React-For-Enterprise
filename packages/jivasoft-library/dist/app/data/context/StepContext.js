...
exports.useStep = exports.StepContextProvider = void 0;
...
const StepContextProvider = _ref => {
  let {
    children,
    initialState,
    reducer
  } = _ref;
  const [stepState, stepDispatch] = (0, _react.useReducer)(reducer, initialState);
  return /*#__PURE__*/_react.default.createElement(StepContext.Provider, {
    value: [stepState, stepDispatch]
  }, children);
};
