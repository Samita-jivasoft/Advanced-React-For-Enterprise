...
exports.createAnimationConfig = exports.convertToRGB = exports.componentToHex = exports.calculateIntermediateColor = void 0;
exports.generateAnimation = generateAnimation;
exports.generateColorShades = void 0;
exports.generateElement = generateElement;
exports.generateElevation = generateElevation;
exports.generateHSLColorVariations = void 0;
exports.generateInteraction = generateInteraction;
exports.generateSpacing = generateSpacing;
exports.generateStyle = generateStyle;
exports.getBestContrastColor = void 0;
exports.getBestShadeForContrast = getBestShadeForContrast;
exports.getLuminance = exports.getContrastRatio = void 0;
exports.getShadows = getShadows;
exports.hexToRgb = void 0;
exports.hexToRgbA = hexToRgbA;
exports.rgbToHex = exports.makeZIndexes = exports.hslToRgb = void 0;
...
var _constants = _interopRequireWildcard(require("app/theme/constants"));
var Constants = _constants;
var Animations = _interopRequireWildcard(require("./constants/animation"));
var Interactions = _interopRequireWildcard(require("./constants/interactions"));
...
const elevationShadow = level => {
  ...
  const shadow = "box-shadow: 0px ".concat(offsetY, "px ").concat(blur, "px rgba(0, 0, 0, ").concat(opacity, "),\n                        0px ").concat(offsetY, "px ").concat(blur / 2, "px rgba(0, 0, 0, ").concat(ambientOpacity, ");");
  return shadow;
};
...
const createAnimationConfig = exports.createAnimationConfig = function createAnimationConfig(animation) {
  let configurations = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  let applyOnHover = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  const {
    duration = _constants.DEFAULT_DURATION,
    timing = _constants.DEFAULT_TIMING,
    iterationCount = _constants.DEFAULT_ITERATION_COUNT,
    direction = _constants.DEFAULT_DIRECTION,
    fillMode = _constants.DEFAULT_FILL_MODE,
    delay = _constants.DEFAULT_DELAY
  } = configurations;
  const animationCSS = (0, _styledComponents.css)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    animation: ", " ", " ", " ", " ", " ", " ;\n    animation-delay: ", ";\n  "])), animation, duration, timing, iterationCount, direction, fillMode, delay);
  if (applyOnHover) {
    return (0, _styledComponents.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["&:hover  { cursor: pointer;\n    ", " }"])), animationCSS);
  } else {
    return animationCSS;
  }
};
const baseSelectable = (0, _styledComponents.css)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  box-shadow: 0px 0px 0px rgba(0, 0, 0, 0); /* Initial state */\n  transform: translateY(0); /* Initial state */\n  transition: box-shadow 0.2s ease-in, transform 0.5s ease-out 0.1s !important; /* Transition properties with different durations */\n  &:hover {\n    cursor: pointer;\n    z-index: 999;\n  }\n"])));
function generateAnimation(props) {
  const {
    type,
    configurations
  } = props;
...
function generateInteraction(props) {
  const {
    type,
    configurations
  } = props;
...
function generateElevation(props) {
  const {
    type
  } = props;
  switch (type) {
    //elevation
    case 'elevation1':
      const e1 = (0, _styledComponents.css)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        ", "\n      "])), elevationShadow(0));
      return e1;
    case 'elevation2':
      const e2 = (0, _styledComponents.css)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n        ", "\n      "])), elevationShadow(1));
      return e2;
    case 'elevation3':
      const e3 = (0, _styledComponents.css)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n        ", "\n      "])), elevationShadow(2));
      return e3;
    case 'elevation4':
      const e4 = (0, _styledComponents.css)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n        ", "\n      "])), elevationShadow(3));
      return e4;
    case 'elevation5':
      const e5 = (0, _styledComponents.css)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n        ", "\n      "])), elevationShadow(4));
      return e5;
  }
}
function generateStyle(props) {
  ...
  switch (type) {
    case 'icon-initial':
      const iconInitial = (0, _styledComponents.css)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n         {\n          white-space: pre;\n          left: 0;\n          transform: translateX(-40%);\n          border: 1px solid rgba(255, 255, 255, 0.5);\n          background: rgba(229, 234, 239);\n          box-shadow: 0px 4px 60px 2px rgba(0, 0, 0, 0.11);\n\n          font-size: ", ";\n          min-width: 2rem;\n          min-height: 2rem;\n        }\n      "])), _ref => {
        var _theme$typography;
        let {
          theme
        } = _ref;
        return theme === null || theme === void 0 || (_theme$typography = theme.typography) === null || _theme$typography === void 0 || (_theme$typography = _theme$typography.body) === null || _theme$typography === void 0 ? void 0 : _theme$typography.b4;
      });
      return iconInitial;
    case 'icon-initial-alt':
      const iconInitialAlt = (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n         {\n          border: 1px solid rgba(255, 255, 255, 0.2);\n          background-color: rgba(255, 255, 255, 0.7);\n          border-radius: 10px;\n          outline: none;\n          transition: all 0.3s ease-in-out;\n          box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2);\n          ", ";\n        }\n      "])), _ref2 => {
        let {
          theme
        } = _ref2;
        return theme === null || theme === void 0 ? void 0 : theme.panela1;
      });
      return iconInitialAlt;
    case 'icon-badge':
      const iconBadge = (0, _styledComponents.css)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n         {\n          padding: 0.05em 0.5em;\n          display: flex;\n          justify-content: center;\n          align-items: center;\n          color: white;\n          z-index: ", ";\n          height: ", ";\n          min-width: ", ";\n          font-size: ", ";\n        }\n      "])), _ref3 => {
        var _theme$zIndexes;
        let {
          theme
        } = _ref3;
        return theme === null || theme === void 0 || (_theme$zIndexes = theme.zIndexes) === null || _theme$zIndexes === void 0 ? void 0 : _theme$zIndexes.notification;
      }, _ref4 => {
        var _theme$typography2;
        let {
          theme
        } = _ref4;
        return theme === null || theme === void 0 || (_theme$typography2 = theme.typography) === null || _theme$typography2 === void 0 || (_theme$typography2 = _theme$typography2.body) === null || _theme$typography2 === void 0 ? void 0 : _theme$typography2.b6;
      }, _ref5 => {
        var _theme$typography3;
        let {
          theme
        } = _ref5;
        return theme === null || theme === void 0 || (_theme$typography3 = theme.typography) === null || _theme$typography3 === void 0 || (_theme$typography3 = _theme$typography3.body) === null || _theme$typography3 === void 0 ? void 0 : _theme$typography3.b6;
      }, _ref6 => {
        var _theme$typography4;
        let {
          theme
        } = _ref6;
        return theme === null || theme === void 0 || (_theme$typography4 = theme.typography) === null || _theme$typography4 === void 0 || (_theme$typography4 = _theme$typography4.body) === null || _theme$typography4 === void 0 ? void 0 : _theme$typography4.b6;
      });
      return iconBadge;
    default:
      return null;
...
function generateSpacing() {
  ...
  Constants.SPACING_VALUES.forEach((val, index) => {
    const key = "sp".concat(index + 1);
    spacing[key] = "".concat(val, "rem");
  });
  return spacing;
}
function generateElement(props) {
  ...
  switch (type) {
    case 'selectable':
      const selectable = (0, _styledComponents.css)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n        ", "\n        &:hover {\n          box-shadow: -3px 8px 25px ", " !important; /* Adjust the shadow values for hover */\n          transform: translateY(-3px) !important; /* Target state on hover */\n        }\n      "])), baseSelectable, color1);
      return selectable;

    //pulsatingSelectable
    case 'pulsatingSelectable':
      const pulseStyle = generateAnimation({
        type: 'lowPulse'
      });
      const pulsatingSelectable = (0, _styledComponents.css)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n        ", "\n        &:hover {\n          ", " ", " !important; /* Adjust the shadow values for hover */\n        ", ";\n        }\n      "])), baseSelectable, elevationShadow(1), color1, pulseStyle);
      return pulsatingSelectable;

    //Selectable variant for different elevation
    //selectableX, where X represents elevation level
    case 'selectable1':
      const selectable1 = (0, _styledComponents.css)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n        ", "\n        &:hover {\n          ", " ", " !important; /* Adjust the shadow values for hover */\n          transform: translateY(-1px) !important; /* Target state on hover */\n        }\n      "])), baseSelectable, elevationShadow(1), color1);
      return selectable1;
    case 'selectable2':
      const selectable2 = (0, _styledComponents.css)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n        ", "\n        &:hover {\n          ", " ", " !important; /* Adjust the shadow values for hover */\n          transform: translateY(-2px) !important; /* Target state on hover */\n        }\n      "])), baseSelectable, elevationShadow(2), color1);
      return selectable2;
    case 'selectable3':
      const selectable3 = (0, _styledComponents.css)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n        ", "\n        &:hover {\n          ", " ", " !important; /* Adjust the shadow values for hover */\n          transform: translateY(-3px) !important; /* Target state on hover */\n        }\n      "])), baseSelectable, elevationShadow(3), color1);
      return selectable3;
    case 'selectable4':
      const selectable4 = (0, _styledComponents.css)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n        ", "\n        &:hover {\n          ", " ", " !important; /* Adjust the shadow values for hover */\n          transform: translateY(-4px) !important; /* Target state on hover */\n        }\n      "])), baseSelectable, elevationShadow(4), color1);
      return selectable4;
    case 'scrollable':
      const scrollable = (0, _styledComponents.css)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n      overflow-y: auto !important;\n       scrollbar-width: auto !important; \n    \n      &:hover {\n        &::-webkit-scrollbar {\n          display: block !important;\n          width: 9px !important;\n          height: 9px !important;\n        }\n    \n        &::-webkit-scrollbar-thumb:hover {\n          background-color: darkgrey !important;\n          cursor: pointer !important;\n        }\n    \n        &::-webkit-scrollbar-thumb {\n          background-color: grey !important;\n          border-radius: 20px !important;\n        }\n      }\n    \n      /* Style the scrollbar buttons */\n      &::-webkit-scrollbar-button {\n        display: none !important;\n      }\n      "])));
      return scrollable;
    case 'dangerpanel':
    case 'panel':
      const panel = (0, _styledComponents.css)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n        border: 1px solid ", ";\n        border-radius: ", ";\n        padding: ", ";\n        box-shadow: ", ";\n\n        @media (max-width: 600px) {\n          border-radius: ", ";\n          padding: ", ";\n        }\n        /* fallback for old browsers */\n        background: ", ";\n        /* gradients */\n        background: -moz-linear-gradient(45deg, ", " 0%, ", " 100%);\n\n        background: linear-gradient(45deg, ", " 0%, ", " 100%);\n        background: -webkit-linear-gradient(\n          45deg,\n          ", " 0%,\n          ", " 100%\n        );\n      "])), border, Constants.DEFAULT_UI_BORDERRADIUS, Constants.DEFAULT_UI_PADDING, getShadows(color1, shadowType), Constants.MOBILE_UI_BORDERRADIUS, Constants.MOBILE_UI_PADDING, color1, color1, color2, color1, color2, color1, color2);
      function arrayToString(arr) {
        return arr.join('');
      }
      return panel;
    case 'pane':
      const pane = (0, _styledComponents.css)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n        border: 1px solid ", ";\n        border-radius: ", ";\n        padding: ", ";\n        //TODO: implement neo-panes ??\n        box-shadow: 0px 0px 0.1px rgba(0, 0, 0, 0.03),\n          0px 0px 1px rgba(0, 0, 0, 0.015);\n\n        @media (max-width: 600px) {\n          border-radius: ", ";\n          padding: ", ";\n        }\n        background: ", ";\n        @supports (-webkit-backdrop-filter: none) or (backdrop-filter: none) {\n          background-color: ", ";\n          -webkit-backdrop-filter: blur(30px);\n          backdrop-filter: blur(2em);\n          -ms-filter: blur(3px);\n        }\n      "])), border, Constants.DEFAULT_UI_BORDERRADIUS, Constants.DEFAULT_UI_PADDING, Constants.MOBILE_UI_BORDERRADIUS, Constants.MOBILE_UI_PADDING, color1, hexToRgbA(color1, transparency));
      return pane;
    case 'material':
      // const material = css`
...
function getShadows(color, type) {
  switch (type) {
    case 'embed':
      return null;
...
function LightenDarkenColor(col, amt) {
  ...
  lightDarkColor = '000000'.substring(0, 6 - lightDarkColor.length) + lightDarkColor; // Pad with leading zeros and to a two-character hexadecimal string

  return (usePound ? '#' : '') + lightDarkColor;
}
function standardizeColor(colour) {
  var colours = {
    aliceblue: '#f0f8ff',
    antiquewhite: '#faebd7',
    aqua: '#00ffff',
...
const generateHSLColorVariations = numVariations => {
...
exports.generateHSLColorVariations = generateHSLColorVariations;
...
const rgbToHex = (r, g, b) => "#".concat(componentToHex(r)).concat(componentToHex(g)).concat(componentToHex(b));
...
const convertToRGB = color => {
  ...
  const rgbaMatch = color === null || color === void 0 ? void 0 : color.match(/^rgba\((\d+),\s*(\d+),\s*(\d+),\s*([\d.]+)\)$/);
  if (rgbaMatch) {
    const [, r, g, b, a] = rgbaMatch;
    return [parseInt(r), parseInt(g), parseInt(b), parseFloat(a)];
  }
  const rgbMatch = color === null || color === void 0 ? void 0 : color.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/);
  if (rgbMatch) {
...
const getLuminance = color => {
  const sRGB = color === null || color === void 0 ? void 0 : color.map(value => {
    value /= 255;
...
const getBestContrastColor = (background, textColors) => {
  ...
  for (const textColor of textColors) {
    ...
    if (!textRgb) {
      console.error("Invalid text color format for color: ".concat(textColor));
      continue;
    }
...
const calculateIntermediateColor = (startColor, percentage) => {
  const hex = color => {
  ...
  const intermediateColorRGB = {
    r: Math.round(startColorRGB.r + (targetColorRGB.r - startColorRGB.r) * percentage),
    g: Math.round(startColorRGB.g + (targetColorRGB.g - startColorRGB.g) * percentage),
    b: Math.round(startColorRGB.b + (targetColorRGB.b - startColorRGB.b) * percentage)
  };
  return "#".concat(hex(intermediateColorRGB.r)).concat(hex(intermediateColorRGB.g)).concat(hex(intermediateColorRGB.b));
};
exports.calculateIntermediateColor = calculateIntermediateColor;
const generateColorShades = (color, shades) => {
  return [...Array(shades)].map((_, step) => calculateIntermediateColor(color, (step + 1) / (shades + 1)));
};
exports.generateColorShades = generateColorShades;
const makeZIndexes = layers => layers.reduce((acc, layerName, index) => {
  const valueName = "".concat(layerName);
  acc[valueName] = index * 100;
  return acc;
}, {});
exports.makeZIndexes = makeZIndexes;
function getBestShadeForContrast(colorFill, shades) {
  return shades.reduce((bestShade, currentShade) => {
    const contrastRatio = getContrastRatio(convertToRGB(colorFill.trim()), convertToRGB(currentShade));
