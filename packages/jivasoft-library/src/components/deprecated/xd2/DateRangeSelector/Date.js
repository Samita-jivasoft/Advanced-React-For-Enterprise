  ...
  return (
    <>
      <DateWrapper>
        ...
        <DateContainer selected={item.selected} fontRem={0.1} fontVMin={2}>
          {item && (
            <DisplayTime viewWidth={viewWidth}>
              {masktype === 'datetime' && item.selected ? (
                <EditIcon onClick={() => item.selected && setShow(true)} />
              ) : (
                <EditOffIcon />
              )}
        ...
        >
          <TimeBackground>
            ...
            <SelectDiv onClick={e => e.stopPropagation()}>
              ...
              <BottomSelectDiv>
                <LabelDiv height={50} width={80} color={'red'}>
                  <InputDiv height={90} width={40}>
                    Start Time &nbsp;
                    ...
                    <StyledTimePicker
                      ...
                      onChange={value => {
                        ...
                        setDateHold({ ...dateHold, starttime: value })
                      }}
                  ...
                  <InputDiv height={90} width={40}>
                    ...
                    <StyledTimePicker
                      ...
                      onChange={value => {
                        ...
                        setDateHold({ ...dateHold, endtime: value })
                      }}
                      format={timeFormat ? 'HH:mm' : ''}
                      disableClock={true}
                      disabled={!item.selected}
