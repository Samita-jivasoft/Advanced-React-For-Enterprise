...
import { formatDatePart } from "@jivasoft/jivasoft-lib/dist/app/helpers";
import {
  XIcon,
  NameDiv,
  LabelDiv,
...
import { TimePicker } from "components/Generic";


export const DateSelector = ({ timeFormat, masktype, dateArray, setDateArray, defaultValue }) => {
