...
export const SearchDropdown = ({ list, data, setData, defaultValue, allowmultiplepicklistselections }) => {
		...
		>
			...
			{showList.length > 0 && (
				<div
					...
					<div style={{
						fontSize: '.8rem', padding: 10, background: themeState.currentTheme.bga2,
