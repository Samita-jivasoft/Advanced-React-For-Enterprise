...
const base = {
  ...
  animation:{
    emphasis:{
      ...
      pulse: generateAnimation({ type: 'pulse', configurations: { duration: '4s', iterationCount: 'infinite' } }),
      lowPulse: generateAnimation({ type: 'lowPulse',configurations: { duration: '1.5s', iterationCount: 'infinite' }  }),
